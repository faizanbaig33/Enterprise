    ...
    public class MultiRootTreeList : TreeList
    {
        protected override void OnLoad(EventArgs args)
        {
            ...
            if (!Sitecore.Context.ClientPage.IsEvent)
            {
                ...
                {
                    var item = Sitecore.Context.ContentDatabase.GetItem(context.Root);
                ...
                var listbox = typeof(TreeList).GetField("_listBox", BindingFlags.Instance | BindingFlags.NonPublic).GetValue(this) as Listbox;
        ...
        protected override bool ValidateSelection(Item selectedItem, Listbox listbox)
        {
            ...
            if (!this.IsDeniedMultipleSelection(selectedItem, listbox))
            {
