...
const pluginDefinitions = [
  ...
  {
    listPath: 'src/temp/coveo-indexing-item-fetcher-plugins.ts',
    rootPath: 'src/lib/coveo/indexing/item-fetcher/plugins',
    moduleType: ModuleType.ESM,
  },
  {
    listPath: 'src/temp/coveo-indexing-item-processor-plugins.ts',
    rootPath: 'src/lib/coveo/indexing/item-processor/plugins',
    moduleType: ModuleType.ESM,
  },
];
