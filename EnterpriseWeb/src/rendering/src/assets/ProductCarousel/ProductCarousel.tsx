...
export type ProductCarouselProps =
  Feature.EnterpriseWeb.Components.General.ProductCarousel.ProductCarousel & {
    fields: {
      children: any;
    };
  } & ComponentProps;
  ...
  return (
    <Component variant="lg" gap="" dataComponent="general/contentblockwithsidebar" {...props}>
      <div className={themeData.classes.columnClass}>
        ...
        <RenderSlider currentSlideIndex={currentSlideIndex} slidesData={slidesData} sliderSettings={sliderSettings} />
