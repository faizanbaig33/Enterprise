...
const RichTextWrapper = ({
  ...
  const NEW_TAB_ICON =
    '<span class="svg-icon inline-flex align-middle w-em h-em ml-[2px] -mt-2"><svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0" y="0" width="15" height="15" viewBox="0, 0, 48, 48"><path d="M19.617,13.401 L19.594,17.697 L10.925,17.697 L10.925,35.793 L29.021,35.793 L29.021,26.281 L33.33,26.269 L33.316,40.088 L6.629,40.088 L6.629,13.401 L19.617,13.401 z M21.914,5.912 L22.008,9.725 L34.219,10.026 L18.268,25.924 L21.031,28.688 L37.243,12.528 L37.558,25.274 L41.371,25.368 L40.902,6.385 L40.898,6.385 L40.898,6.38 L21.914,5.912 z" fill="currentColor"/></svg></span>';
  ...
  return (
    <div className={classNames(refer, classes)}>
      <RichText field={{ value: updatedContent }} {...props} />
    </div>
  );
};
