...
const SamplePlaceholderComponent = (): JSX.Element => (
  <div className={classNames('w-full', 'p-6', 'text-center', 'rounded-md', 'bg-blue-peacock')}>
    <p className="font-normal, text-white">Placeholder content</p>
  </div>
);
