...
export const ProductCarouselTheme: ThemeFile = {
  aw: {
    classes: {
      ...
      arrowPrevButtonWrapperClass:
        'flex justify-between items-center absolute top-[45%] sm:left-20 pl-4.5 md:pl-0 md:left-[26%] lg:left-[35%]',
      arrowNextButtonWrapperClass:
        'flex justify-between items-center absolute top-[45%] sm:right-20 pr-4.5 md:pr-0 md:right-[26%] lg:right-[35%]',
      arrowButtonClass:
  ...
  rba: {
    classes: {
      ...
      exploreButtonClass: 'w-full flex justify-center mt-8',
      arrowPrevButtonWrapperClass:
        'flex justify-between items-center absolute top-[40%] left-0 px-2.5 md:pl-0 md:left-[23%] lg:left-[33%]',
      arrowNextButtonWrapperClass:
        'flex justify-between items-center absolute top-[40%] right-0 px-2.5 md:pr-0 md:right-[23%] lg:right-[33%]',
      arrowButtonClass:
        'button w-11 h-11 flex items-center justify-center rounded-full border-2 border-[#C4BFB6] bg-white cursor-pointer text-[#001722] transition hover:bg-[#001722] hover:text-white hover:border-[#001722]',
    },
  },
