  ...
  switch (swatchStyle) {
    case 'small-circles':
      ...
      swatchesGap = classNames(
        'gap-y-m gap-x-[35px] ml:gap-x-[62px] ml:justify-start pl-xxs ',
    ...
    case 'large-circles':
      ...
      swatchWidth = 'w-xxl ml:w-[160px] pl-s ml:pl-0';
      swatchesGap = classNames(
        'gap-x-[52px] gap-y-m ml:gap-x-[38px] ml:justify-start pl-xxs ml:pl-0',
        themeName === 'rba' ? 'my-m' : ''
      );
      break;
    ...
    case 'square':
      ...
      swatchesGap = classNames(
        'gap-x-[15px]  gap-y-m',
        themeName === 'rba' ? 'mt-m mb-l ml:gap-x-l' : 'ml:gap-x-[43px]'
      );
      break;
  }
