  ...
  aw: {
    classes: {
      ...
      tabsClasses: {
        ...
        tabTitlesContainer: 'relative flex order-3 ml:order-none',
        leftArrowIcon:
        ...
        tabTitle:
          'text-body ml:text-xs text-dark-gray cursor-pointer mx-xxs ml:mx-0 py-xxxs ml:px-xxs ml:border-l-2 my-s snap-start whitespace-nowrap',
      ...
      promoClasses: {
        promoContainer:
          'bg-theme-bg h-full flex flex-col ml:flex-row items-center justify-between p-m ml:px-xl ml:py-l',
  ...
  rba: {
    classes: {
      ...
      tabsClasses: {
        ...
        tabTitle:
          'text-body text-dark-gray cursor-pointer mr-m ml:mr-0 my-xxxs snap-start whitespace-nowrap',
        activeTabTitle:
      ...
      promoClasses: {
        promoContainer:
          'ml:relative bg-theme-bg h-full w-full flex flex-col ml:flex-row items-center justify-between p-[32px]',
        ...
        promoImageCaption: 'relative text-xxs ml:text-body',
      },
    },
  },
};
