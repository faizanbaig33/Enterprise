...
export type HeroMediaBackgroundProps = Feature.EnterpriseWeb.Components.Hero.HeroMediaBackground &
  ComponentProps;
const HeroMediaBackground = (props: HeroMediaBackgroundProps) => {
  ...
  return (
    <div data-component="hero/heromediabackground" className="relative">
