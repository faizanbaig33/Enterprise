...
export const FavoriteProductsTheme: ThemeFile = {
  aw: {
    classes: {
      mainheadline: 'font-sans font-heavy text-black text-m',
      ...
      headlineWrapper: 'order-2 font-heavy font-sans',
      ...
      priceText:
        'border-l border-secondary px-xxs font-sans leading-none flex [&>*:nth-child(2)]:text-gray',
